...
public class MoStMLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MoStMLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getRANGAccess().getCompOperator2Assignment_3(), "rule__RANG__CompOperator2Assignment_3");
			builder.put(grammarAccess.getRANGAccess().getBound2Assignment_4(), "rule__RANG__Bound2Assignment_4");
			builder.put(grammarAccess.getRANGAccess().getUnitAssignment_5(), "rule__RANG__UnitAssignment_5");
